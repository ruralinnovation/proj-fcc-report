...
## Excluding DSL to the underserved

- [ ] add States names   
- [ ] add total locations
- [ ] add total locations underserved if we included DSL
...
#| eval: false
geoid_st,
	count(*) as number_block,
	sum(underserved_dsl_excluded) as cnt_locations_underserved,
...
```{r}
eligibiliy_st_ntia <- read.csv("data/dsl-exluded.csv")
...
## Stuff I am keeping but should be deleted later
